...
namespace ChartApp.Actors
{
    ...
    {
        #region Messsage types

        /// <summary>
        /// Toggles this button on or off and sends an appropriate message to
        /// the <see cref="PerformanceCounterCoordinatorActor"/>
        /// </summary>
        public class Toggle { }
        ...
        public ButtonToggleActor(CounterType myCounterType, Button myButton, 
            IActorRef coordinatorActor, bool isToggledOn = false)
        {
